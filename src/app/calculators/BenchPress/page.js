...
// Strength standards data based on common public data sets.
// Bodyweight is the key (in kg), and values are estimated 1RM in kg.
const benchPressStandards = {
    male: {
        52: { beginner: 40, intermediate: 60, advanced: 85 },
        56: { beginner: 45, intermediate: 67.5, advanced: 95 },
        60: { beginner: 50, intermediate: 75, advanced: 105 },
        67.5: { beginner: 60, intermediate: 90, advanced: 122.5 },
        75: { beginner: 70, intermediate: 102.5, advanced: 140 },
        82.5: { beginner: 77.5, intermediate: 115, advanced: 155 },
        90: { beginner: 85, intermediate: 125, advanced: 170 },
        100: { beginner: 92.5, intermediate: 137.5, advanced: 185 },
        110: { beginner: 100, intermediate: 147.5, advanced: 197.5 },
        120: { beginner: 105, intermediate: 155, advanced: 210 },
    },
    female: {
        44: { beginner: 25, intermediate: 37.5, advanced: 52.5 },
        48: { beginner: 27.5, intermediate: 42.5, advanced: 60 },
        52: { beginner: 32.5, intermediate: 47.5, advanced: 67.5 },
        56: { beginner: 35, intermediate: 52.5, advanced: 75 },
        60: { beginner: 37.5, intermediate: 57.5, advanced: 82.5 },
        67.5: { beginner: 42.5, intermediate: 65, advanced: 92.5 },
        75: { beginner: 47.5, intermediate: 72.5, advanced: 102.5 },
        82.5: { beginner: 50, intermediate: 77.5, advanced: 110 },
        90: { beginner: 55, intermediate: 82.5, advanced: 117.5 },
    }
};

// Main App component for the Bench Press Standards Calculator
export default function App() {
    ...
    const calculateStandards = () => {
        ...
        const genderStandards = benchPressStandards[gender];
            ...
            <div className="flex items-center justify-center min-h-screen bg-black font-sans text-white">
                <div className="p-8 space-y-6 max-w-md w-full">
                    ...
                    <div className="text-center">
                        <h1 className="text-4xl font-bold text-purple-400">Bench Press Standards</h1>
                    ...
                    {standards && (
                        <div className="mt-8 p-6 bg-gray-800 rounded-2xl shadow-lg text-center transition-all duration-500 transform animate-fade-in space-y-4">
                            <h2 className="text-2xl font-bold text-gray-200">Estimated 1-Rep Max Bench Press</h2>
                            {/* Beginner */}
                            <div>
